...
class TestModelAnalyzerEdgeCases:
    ...
    def test_empty_calibration(self):
        ...
        param_nodes = [var for var, meta in result.node_meta.items() 
                      if meta["kind"] == "param"]
    ...
    def test_block_with_no_rewards(self):
        ...
        reward_nodes = [var for var, meta in result.node_meta.items() 
                       if meta["kind"] == "reward"]
...
class TestAgentAssignments:
    ...
    def test_block_agent_override(self, simple_block):
        ...
        state_vars = [var for var, meta in result.node_meta.items() 
                     if meta["kind"] == "state"]
