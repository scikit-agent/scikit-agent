...
def test_identify_variables():
    ...
    print("✓ Parm variables assertion passed")
...
def test_extract_formulas():
    ...
    reference_formula_vars = set(block.dynamics.keys()) | set(block.reward.keys()) | set(calibration.keys())
...
def test_agent_attribution():
    ...
    for agent, vars_list in agent_attribution.items():
        for var in vars_list:
            ...
            print(f"✓ Regular variable attribution assertion for {var} -> {agent} passed")
